...
# Replace the existing injected overlay with the current September schedule.
...
(function(){
  const ROTATION_ENDS={
    raid:{
      // Current Mega Squads lineup
      'Mega Beedrill':'2026-09-15T22:00:00','Mega Houndoom':'2026-09-15T22:00:00','Zacian - Hero':'2026-09-15T22:00:00','Hero Zacian':'2026-09-15T22:00:00',
      ...
      // September regular rotation
      'Mega Venusaur':'2026-09-22T22:00:00','Zamazenta - Hero':'2026-09-22T22:00:00','Hero Zamazenta':'2026-09-22T22:00:00',
      ...
      // Shadow rotation runs through the October 6 rotation
      'Shadow Thundurus':'2026-10-06T22:00:00','Shadow Bagon':'2026-10-06T22:00:00','Shadow Bellsprout':'2026-10-06T22:00:00','Shadow Machop':'2026-10-06T22:00:00','Shadow Torchic':'2026-10-06T22:00:00','Shadow Alolan Sandslash':'2026-10-06T22:00:00','Shadow Quagsire':'2026-10-06T22:00:00','Shadow Lampent':'2026-10-06T22:00:00'
    },
    max:{
  ...
  const normalize=n=>String(n||'').replace(/^Dynamax\s+/i,'').replace(/\s+\(Hero of Many Battles\)$/i,'').trim();
