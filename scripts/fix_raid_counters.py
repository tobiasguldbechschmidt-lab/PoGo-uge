...
function raidDetails(r){
  ...
  Object.keys(RAID_WEAK).forEach(atk=>{
    ...
    types.forEach(def=>{
      ...
      if((resist[atk]||[]).includes(def)) mult*=1/1.6;
    });
